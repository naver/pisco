...
def main(config: DictConfig):
    ...
    model.prepare(
        retrieval_pooling=getattr(config, "retrieval_pooling", None),
        decoder_gradient_checkpointing=getattr(
            config, "decoder_gradient_checkpointing", False
        ),
        compressor_gradient_checkpointing=getattr(
            config, "compressor_gradient_checkpointing", False
        ),
    )
    ...
    train_ds, eval_ds = prepare_dataset(ds, config)
